...
const fetchDataAndCallPython = require('./fetchDataAndCallPython'); // Importing the function
...
app.post('/transcripts', (req, res) => {
    ...
    newTranscript.save()
        .then(() => {
            ...
            // Call fetchDataAndCallPython and fetchDataAndSendToClient functions after saving the transcript
            fetchDataAndCallPython(app);
        })
        .catch(err => {
